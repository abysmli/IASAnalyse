...
/**
 * Created by Li, Yuan on 11.09.15.
 * All Right reserved!
 */
public class AppSetting {
    public static final String PMSIPAddress = "http://192.168.1.107:8080/PMS";
    public static String DeviceAddress = "http://192.168.1.107:3000";
    public static final String DevicePort = "3000";
    public static final String COMPONENT_ID = "net.icedeer.IASAnalyse.ComponentId";
    public static String LogFileName = "runningLog";
